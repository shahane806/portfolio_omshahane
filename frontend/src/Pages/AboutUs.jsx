    ...
    <main className="bg-gray-900 text-white">
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          {[{ name: 'John Doe', role: 'Lead Developer', img: 'john.jpg', rating: 4.5, desc: 'Expert in MERN stack with a passion for innovative problem solving.' },
            { name: 'Jane Smith', role: 'UI/UX Designer', img: 'jane.jpg', rating: 5.0, desc: 'Focused on crafting intuitive and aesthetically pleasing user interfaces.' },
            { name: 'Alex Brown', role: 'Backend Engineer', img: 'alex.jpg', rating: 4.7, desc: 'Building scalable and efficient backend solutions with Node.js.' }]
            .map((member, index) => (
              <motion.div
                key={member.name}
                initial={{ opacity: 0 }}
              ...
              >
                <img src={`/images/${member.img}`} alt={member.name} className="w-full h-48 object-cover rounded-lg mb-4" />
