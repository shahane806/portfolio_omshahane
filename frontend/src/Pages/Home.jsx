...
const Home = () => {
  ...
  return (
    <main className="bg-gradient-to-r from-indigo-900 to-blue-900 text-white font-sans scroll-smooth">
      ...
      <section id="experience" className="py-20 bg-gradient-to-r from-blue-900 to-indigo-900 text-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative space-y-12">
            ...
            <motion.div
              ...
              className="flex flex-col md:flex-row items-center md:justify-between relative"
            >
              {/* Make sure the order and positioning are symmetrical */}
              ...
              <div className="md:w-5/12 order-2 md:ml-auto">
                <div className="bg-gray-800 rounded-xl p-8 shadow-2xl hover:shadow-indigo-500/20 transition-all duration-300">
            ...
            >
              <div className="md:w-5/12 order-2 md:order-1">
                <div className="bg-gray-800 rounded-xl p-8 shadow-2xl hover:shadow-indigo-500/20 transition-all duration-300">
                  <h3 className="text-2xl font-bold text-indigo-300">Software Engineer</h3>
                  <p className="text-lg text-gray-400">Tech Innovations | 2023 - Present</p>
                  <p className="mt-4 text-gray-200 leading-relaxed">
                    Engineered high-performance software solutions, focusing on system optimization and scalability. Implemented advanced features for high-traffic applications, ensuring reliability and efficiency.
                  </p>
                  <div className="mt-4 flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-indigo-600 text-sm rounded-full">System Architecture</span>
                    <span className="px-3 py-1 bg-indigo-600 text-sm rounded-full">Performance Optimization</span>
                    <span className="px-3 py-1 bg-indigo-600 text-sm rounded-full">Scalability</span>
                  </div>
                </div>
              </div>
              <div className="w-12 h-12 rounded-full bg-indigo-500 flex items-center justify-center border-4 border-white shadow-lg mb-6 md:mb-0 order-1 md:order-2 z-10 md:absolute md:left-1/2 md:-translate-x-1/2">
